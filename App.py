...
connection = pymysql.connect(host='localhost',user='root',password='#anlasaSu1',db='cv')
...
def run():
    ...
    img = Image.open('./Logo/yt_thumb.png')
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'yogi' and ad_password == 'yogi':
                st.success("Welcome Yogiraj")
                # Display Data
